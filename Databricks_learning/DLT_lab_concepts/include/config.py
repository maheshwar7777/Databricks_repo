...
C_CATALOG           = "dlt_catalog"   # Unity Catalog catalog name (unique per user)  # using existing catalog
DLT_DATABASE      = "dlt" # Used for raw data 



# Volume & Data Paths
VOLUME_NAME       = "dlt_volume"                                          # Unity Catalog volume name
BASE_PATH         = f"/Volumes/{C_CATALOG}/{DLT_DATABASE}/{VOLUME_NAME}/input_files"     # Raw data input path
# SCHEMA_PATH       = f"/Volumes/{C_CATALOG}/{DLT_DATABASE}/{VOLUME_NAME}/input_file_ddl"            # Schema inference path
# DQE               = f"/Volumes/{C_CATALOG}/{DLT_DATABASE}/{VOLUME_NAME}/dqe"             # data quality expections file path
# ON_BOARDING_JSON  = f"/Volumes/{C_CATALOG}/{DLT_DATABASE}/{VOLUME_NAME}/onboarding"      # Onboarding json file path
# TRANSFORMATION    = f"/Volumes/{CATC_CATALOGALOG}/{DLT_DATABASE}/{VOLUME_NAME}/transformation"  # Transformation path
