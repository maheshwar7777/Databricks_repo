...
# MAGIC %md
# MAGIC ###Create bronze and silver dataflowsepc empty tables 
...
# MAGIC %md
# MAGIC ###Onboard onboarding json configuration into dataflow spec tables
...
# MAGIC %md
# MAGIC ### Bronze dataflowspec table
...
# MAGIC %md
# MAGIC ### Silver dataflowspec table
